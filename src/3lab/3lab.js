...
function formatCSVFileToJSONFile(input, output, delimiter) {
    return __awaiter(this, void 0, void 0, function () {
        var csv, line, jsonArr, json;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, (0, promises_1.readFile)(input, "utf8")];
                case 1:
                    csv = _a.sent();
                    line = csv.split(/\r?\n/);
                    if (line.length === 0) {
                    ...
                    jsonArr = csvToJSON(line, delimiter);
                    json = JSON.stringify(jsonArr, null, 2);
                    (0, promises_1.writeFile)(output, json, 'utf8');
                    return [2 /*return*/];
            }
        });
    });
